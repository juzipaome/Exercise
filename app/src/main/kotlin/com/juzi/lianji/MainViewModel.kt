...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun addPastWorkout(planId:Long,exerciseIds:List<String>,date:LocalDate,startMinute:Int,endMinute:Int)=viewModelScope.launch { repository.addPastWorkout(planId,exerciseIds,date,startMinute,endMinute) }
